...
Forensics](Solid_State_Drive_(SSD)_Forensics "wikilink")
...
here](Past_Selected_Articles "wikilink").)
...
Denis Frati ([CAINE](CAINE_Live_CD "wikilink") developer) wrote an
[excellent review
...
[Overcoming Impediments to Cell Phone Forensics](Media:JensenCellPhones.pdf "wikilink"), Wayne Jansen, Aurelien Delaitre, and Ludovic Moenner, Proceedings of the 41st Hawaii International Conference on System Sciences - 2008
...
[Semi-Supervised Named Entity Recognition](Media:Thesis-David-Nadeau.pdf "wikilink"): Learning to Recognize 100 Entity Types with Little Supervision, David Nadeau, PhD Thesis, University of Ottawa, 2007.
