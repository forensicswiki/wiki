...
- [InfoViz Toolkit](http://ivtk.sourceforge.net/) - Java, originally
  developed at [INRA](INRA "wikilink").
...
- [OpenMap](http://openmap.bbn.com/) A Java-based Geographical
  Information System framework, from [BBN](BBN "wikilink").
...
- [Graphviz](http://www.graphviz.org/) - Originally developed by the
  ...
  [PostScript](PostScript "wikilink"), [PNG](PNG "wikilink"),
  [GIF](GIF "wikilink"), or as an annotated graph file with the
  locations of all of the objects — ideal for drawing in a GUI. Runs
  from the command line on [Unix](Unix "wikilink"),
  [Windows](Windows "wikilink") and [Mac](Mac "wikilink"), although
...
- [aiSee Graph Layout Software](http://www.aisee.com/) - Supports 15
  ...
  [Windows](Windows "wikilink"), [Linux](Linux "wikilink"),
  [Solaris](Solaris "wikilink"), [NetBSD](NetBSD "wikilink"), and
  [MacOS](MacOS "wikilink"). 30-day trial and free registered versions
  available. Academic pricing available.
- [Geomantics](http://www.geomantics.com/) - Geographical, Visualization
  and Graphics software. Runs on [Windows](Windows "wikilink").
- [Graphis 2D and 3D graphing software](http://www.kylebank.com/) - Runs
  on [Windows](Windows "wikilink"). Free 30-day evaluation copy
  available.
...
- [Network Data Visualizations](Network_Data_Visualizations "wikilink")
