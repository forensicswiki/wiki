...
| 7        | MacCyrillic        | Encoding used for Cyrillic scripts, also see: [Wikipedia: Mac OS Cyrillic encoding](https://en.wikipedia.org/wiki/Mac_OS_Cyrillic_encoding), [Unicode.org: CYRILLIC.TXT](https://www.unicode.org/Public/MAPPINGS/VENDORS/APPLE/CYRILLIC.TXT). Note that MacCyrillic supersedes the MacCyrillic encoding prior to Mac OS 9.0 (sometimes referred to as MacCyrillicCurrSignStdVariant, MacRussian or Microsoft codepage 10007) and [MacUkrainian](https://en.wikipedia.org/wiki/Mac_OS_Ukrainian_encoding), [Unicode.org: UKRAINE.TXT](https://www.unicode.org/Public/MAPPINGS/VENDORS/APPLE/UKRAINE.TXT) (sometimes referred to as MacCyrillicCurrSignUkrVariant or Microsoft codepage 10017). |
