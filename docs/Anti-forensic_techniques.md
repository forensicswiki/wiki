...
investigators](forensic_investigator "wikilink") and their
...
This can include refusing to run when [debugging](debugging "wikilink")
mode is enabled, refusing to run when running inside of a [virtual
machine](virtual_machine "wikilink"), or deliberately overwriting data.
...
like any [tool](Tools "wikilink") they can be abused.
...
[Securely deleting](Secure_data_deletion "wikilink") data, so that it
...
[sanitizing](Sanitizing_Tools "wikilink") data from ATA drives with
...
For example, [Timestomp](Timestomp "wikilink") will overwrite
[NTFS](NTFS "wikilink") “create,” “modify,” “access,” and “change”
timestamps ([Metasploit](Metasploi "wikilink") 2006). [The Defiler’s
Toolkit](The_Defiler’s_Toolkit "wikilink") can overwrite inode
...
command ([The Grugq](The_Grugq "wikilink") 2003).
...
[SSL](SSL_forensics "wikilink") and SSH only protect the content of the
...
*More information: [Tor](Tor "wikilink") and [VPN](VPN "wikilink").*
...
[FreeOTFE](FreeOTFE "wikilink") and [TrueCrypt](TrueCrypt "wikilink")
...
Area](DCO_and_HPA "wikilink") (HPA) and the [Device Configuration
Overlay](DCO_and_HPA "wikilink") (DCO) areas of modern ATA hard drives.
...
[investigator](investigator "wikilink") tries to perform a (live)
...
![](Grml.png "Grml.png") mounted root file system on the [hard
...
(typically [SquashFS](SquashFS "wikilink")) on the local data storage
media during the boot, mount it, and execute */sbin/init* program on
mounted root. Most forensic Linux distributions based on
[Ubuntu](Ubuntu "wikilink") and [Debian](Debian "wikilink") lack of
...
- [Anti-forensics tools
  category](:Category:Anti-forensics_tools "wikilink")
...
- [Low Down and Dirty: Anti-forensic
  ...
  by [Darren Bilby](Darren_Bilby "wikilink"), Blackhat Japan 2006
