**mdd**, also known as **[ManTech dd](ManTech "wikilink")** or **Memory
dd**, is a command line program to acquire an image of the memory of a
running [Windows](Windows "wikilink") computer. The program has been
included in the [Helix](Helix "wikilink") incident response tool.
...
Mehod](Memory_Imaging "wikilink") and returns a file handle to a
