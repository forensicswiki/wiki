...
a [distribution](distribution_Linux "wikilink")
[live](Live_CD "wikilink") oriented to Computer Forensics ([computer
forensics](computer_forensics "wikilink")) historically conceived by
...
Linux](Ubuntu_Linux "wikilink") 12.04 LTS, MATE and LightDM. Compared to
...
[NIST](NIST "wikilink") View [the methodologies of
...
[RBFstab](RBFstab "wikilink") is set to treat [EXT3](EXT3 "wikilink") as
a [EXT4](EXT4 "wikilink")*noload with the option* to avoid automatic
recovery of any corrupt Journal of '[EXT3](EXT3 "wikilink");

- Swap file off: patch that avoids modifying the file
  [swap](swap "wikilink") in systems with limited memory
  [RAM](RAM "wikilink"), avoiding the alteration of the original
...
- Autopsy
- [The SleuthKit](The_SleuthKit "wikilink")
- [Sfdumper 2.2](Selective_file_dumper "wikilink")
- Fundl 2.0
- Scalpel
- Foremost
- Stegdetect
