...
Next, we want mkdocs to load all of the pages of the Forensicswiki.  Mkdocs needs two things to be able to run and load the Forensicswiki pages.  

-  It will need a `docs` directory which holds all of Forensicswiki pages.
