...
DOCX should not be confused with [DOC](DOC "wikilink"), the format used
by earlier versions of Microsoft Office.

# Container Format

DOCX is written in an XML format, which consists of a [ZIP
archive](ZIP_archive "wikilink") file containing [XML](XML "wikilink")
...
- [Introducing the Office (2007) Open XML File
  ...
  [Microsoft](Microsoft "wikilink"), May 2006
- [DCMI Metadata
...
- [The new XML Office Document Files: Implications For
  ...
  [Simson L. Garfinkel](Simson_L._Garfinkel "wikilink") and James
  Migletz
- [Perl script that displays metadata information that is extracted from
  ...
  [Kristinn Gudjonsson](Kristinn_Gudjonsson "wikilink"), June 2009
- [Perl script that displays the content of a Docx document, similar to
  ...
  by [Kristinn Gudjonsson](Kristinn_Gudjonsson "wikilink"), July 2009
- [Office 2007
  Metadata](http://computer-forensics.sans.org/blog/2009/07/10/office-2007-metadata/),
  by [Kristinn Gudjonsson](Kristinn_Gudjonsson "wikilink"), July 10,
  2009
