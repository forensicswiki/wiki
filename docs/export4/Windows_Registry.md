...
Registry File (REGF)](Windows_NT_Registry_File_(REGF) "wikilink")
format.
...
File (CREG)](Windows_9x_Registry_File_(CREG) "wikilink") format.
...
- [Forensic Artifacts](Artifacts "wikilink")
...
| <b>[Artifact name](Artifacts "wikilink")</b> | WindowsServiceControlManagerExtension               |
...
- [The Windows NT Registry File
  ...
  [Timothy Morgan](Timothy_Morgan "wikilink"), June 9, 2009
...
- [Recovering Deleted Data From the Windows
  ...
  by [Timothy Morgan](Timothy_Morgan "wikilink"), DFRWS 2008
...
- \[<https://msdn.microsoft.com/en-us/library/aa384232(VS.85>).aspx
  Registry Redirector\], by [Microsoft](Microsoft "wikilink")
...
- [Understand and Control Startup Apps with the System Configuration
  ...
  by [Microsoft Technet](Microsoft "wikilink")
...
- [Auto-Start Extensibility Points
  ...
  [RegRipper project](Regripper "wikilink"), April 29, 2013
...
- [Volatility autoruns
  ...
  by the [Volatility project](Volatility "wikilink"), April 14, 2015
...
- [More on (the) UserAssist
  ...
  by [Harlan Carvey](Harlan_Carvey "wikilink"), Monday, September 03,
  2007
...
- [Daily Blog \#45: Understanding the artifacts: User
  ...
  by [David Cowen](David_Cowen "wikilink"), Wednesday, August 7, 2013
...
- [Forensic Registry EDitor (fred)](https://www.pinguin.lu/index.php) -
  ...
  editor" by [Daniel Gillen](Daniel_Gillen "wikilink")
...
- [RegRipper](Regripper "wikilink") — "the fastest, easiest, and best
...
- [Registry Decoder](http://code.google.com/p/registrydecoder/) offline
  analysis component, by [Andrew Case](Andrew_Case "wikilink")
- [RegDecoderLive](http://code.google.com/p/registrydecoder/) live hive
  acquisition component, by [Andrew Case](Andrew_Case "wikilink")
- [libregf](libregf "wikilink") - Library and tools to access the
  Windows NT Registry File (REGF) format
- [Registryasxml](Registryasxml "wikilink") - Tool to import/export
