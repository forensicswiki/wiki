[Microsoft](Microsoft "wikilink") [Outlook](Outlook "wikilink") uses the
...
- The **Offline Storage Table (OST)**, which contains items like
  ...
  mailbox files in conjunction with [Microsoft](Microsoft "wikilink")
  [Exchange](Exchange "wikilink"). These files have the extension
...
sources claim the following [MIME types](MIME_types "wikilink") apply to
this [file format](file_format "wikilink"):
...
- MVCOM
- [MailXaminer](MailXaminer "wikilink")
- [Outlook PST Viewer](Outlook_PST_Viewer "wikilink")
- [Pst file viewer](Pst_file_viewer "wikilink")
- PST Scanner
- Windows Messaging

[Category:Email](Category:Email "wikilink") [Category:File
Formats](Category:File_Formats "wikilink") [Category:Database File
