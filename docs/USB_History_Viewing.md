Microsoft [Windows](Windows "wikilink") operating systems records
artifacts when [USB](USB "wikilink") removable storage devices (thumb
...
in the [setupapi log](Setup_API_Logs "wikilink") file. For example:
...
key](Windows_Registry "wikilink"), a unique instance ID key will be
...
These are Device Class [GUID](Universally_Unique_Identifier "wikilink")
...
By default, [Windows](Windows "wikilink") systems are configured to
...
- [UVCView](https://docs.microsoft.com/en-us/windows-hardware/drivers/stream/avstream-testing-and-debugging)
  ...
  [Windows](Windows "wikilink") Driver Kit (WDK) that allows you to view
