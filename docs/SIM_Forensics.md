...
The [SIM Card](SIM_Card "wikilink") is the basic memory device inside of
many mobile phones in use today. This small piece of hardware has been
key to solving many cases in the world of [SIM Card
Forensics](SIM_Card_Forensics "wikilink"). However, without the proper
knowledge of the SIM card's filesystem, the user will be missing out on
all the valuable information the [SIM Card](SIM_Card "wikilink") holds.
...
1.  [Windows](Windows "wikilink") operating system
2.  [SIMCon](SIMCon "wikilink")[1](http://www.simcon.no/)
    - Program used to read SIM Cards
3.  [SIM Cards](SIM_Cards "wikilink")
4.  SIM Card Reader
...
- List of all PLMN's (see
  [Sim_Filesystem#PLMN](Sim_Filesystem#PLMN "wikilink"))
...
- Location Information
  - Contains Location Area Identity (see
    [Sim_Filesystem#LAI](Sim_Filesystem#LAI "wikilink"))
