Google Chrome is a [web browser](Web_Browser "wikilink") developed by
Google Inc.
...
Format](Chrome_Disk_Cache_Format "wikilink") and can be found in:
...
the [SQLite database format](SQLite_database_format "wikilink").
...
- [Chrome Disk Cache Format](Chrome_Disk_Cache_Format "wikilink")
