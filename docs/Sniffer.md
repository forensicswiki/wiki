...
- Detecting network sniffers using a [honeypot](honeypot "wikilink")
...
- [Encryption](Encryption "wikilink"): [VPN](VPN "wikilink") tunnels,
  SSH tunnels, [Tor](Tor "wikilink").

<!-- -->

- [Hidden channels](Hidden_channels "wikilink")
